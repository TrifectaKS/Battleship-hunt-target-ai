try { window.scriptsLoaded = window.scriptsLoaded || {}; window.scriptProcessStart = window.scriptProcessStart || {}; window.scriptProcessStart['adal.min.js'] = (new Date()).getTime();
...
window.scriptsLoaded['adal.min.js'] = 1; window.scriptProcessEnd = window.scriptProcessEnd || {}; window.scriptProcessEnd['adal.min.js'] = (new Date()).getTime(); } catch(e) { window.owaLastErrorReported = e; throw e; }
